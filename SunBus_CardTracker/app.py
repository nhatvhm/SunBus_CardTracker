...
class HEADER_MODE:
	...
	DOWNLOAD_0  = ["eb03", False, False]			#03eb #body=e8030000
	DOWNLOAD_1  = ["df05", False, False]			#05df #body=0109000500000000000000
	DOWNLOAD_2  = ["dd05", False, False]			#05dd #MASSIVE DB
	DOWNLOAD_3  = ["ea03", False, False]			#03ea
